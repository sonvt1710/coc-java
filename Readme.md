...
- `java.transport`: Transport used to communicate with the Java Language Server. Use `"stdio"` when the default pipe transport cannot establish a connection. Default: `"pipe"`
  Valid options: ["pipe","stdio"]
